...
public class TestA1 {
     ...
     */
    private static Logger logger = LoggerFactory.getLogger(TestA1.class);
...
//        String lexicons = "resources/lexicons/UMLS_neji/";
        ...
        String fileOut = "/Volumes/data/Dropbox/corpora/test/out/bug.a1";
...
//            p.addModule(xml);
            ...
            // Writer
            A1Writer writer = new A1Writer(c);
            p.addModule(writer);
