 ...
 * @author david
 */
public class TestIeXML {

    /**
     * {@link Logger} to be used in the class.
     */
    private static Logger logger = LoggerFactory.getLogger(TestIeXML.class);
...
//        String lexicons = "resources/lexicons/UMLS_neji/";
        ...
        String fileOut = "/Volumes/data/Dropbox/corpora/test/out/bug4.xml";
...
//            p.addModule(xml);
            ...
            // Writer
            IeXMLWriter writer = new IeXMLWriter(c, 2, false, false);
            p.addModule(writer);
